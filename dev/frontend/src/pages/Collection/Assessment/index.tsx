    ...
    <div className={styles.container}>
      ...
      <Card title="考核规则说明" style={{ marginTop: 16 }}>
        <div className={styles.rules}>
          <p><strong>1. 一级考核(3-5天)：</strong>催收任务3天未提交结果，营销师10元/任务、营销经理20元/任务</p>
          <p><strong>2. 二级考核(5-7天)：</strong>5天仍未提交，追加营销师20元/任务、营销经理40元/任务</p>
          <p><strong>3. 三级考核(7天以上)：</strong>7天仍未提交，按欠款金额全额考核，营销师70%、营销经理30%</p>

    ...
    <div className={styles.container}>
      ...
      <Card title="考核规则说明" style={{ marginTop: 16 }}>
        <div className={styles.rules}>
          <p><strong>1. 采购确认超时考核：</strong>退货单创建后，采购主管未在当天确认规则，超时期间按 10元/天/单 累计考核</p>
          <p><strong>2. 营销未完成销售考核：</strong>无法采购退货的商品过期前未清仓，按商品进价全额考核营销师</p>
          <p><strong>3. 退货时保质期不足考核：</strong>退货时剩余保质期低于15天，按商品进价全额考核营销师</p>
          <p><strong>4. ERP录入超时考核：</strong>采购确认后30天内未录入ERP，超时期间按 10元/天/单 累计考核</p>
          <p><strong>5. 仓储执行超时考核：</strong>ERP录入后7天内未执行退货，超时期间按 10元/天/单/商品 累计考核（考核对象：仓储主管、库管员、物流主管）</p>
        </div>
      </Card>
    </div>
  );

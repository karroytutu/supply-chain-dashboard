...
import type { ERPDebtRecord, EnrichedDebtRecord, CustomerLimits } from './erp-debt.types';
 ...
 * @usedBy oa/ar-collection-creator.ts, ar-warning.query.ts, ar-warning.task.ts
 */
...
export async function fetchHoardTags(
  ...
  // 从 API 获取缺失的 hoardTag：按客户分组获取结算单

...
const purchasePaymentFormSchema: FormSchema = {
  fields: [
    ...
    // 行内搜索下拉模式：每行一个 Select 搜索 ERP 银行账户 + 填金额
    {
      ...
      // 两种付款模式均显示（出纳环节填写，发起/审批环节通过 fieldPermissions 隐藏）
    },
...
export const purchasePaymentFormType: FormTypeDefinition = {
  ...
  fieldPermissions: {
    nodes: {
      "0": { "remark": "editable", "debtIds": "editable", "erpBillStr": "hidden", "supplierId": "editable", "paymentType": "editable", "receiptUrls": "hidden", "actualAmount": "hidden", "paymentLines": "hidden", "prepayAmount": "editable", "paymentAmount": "editable", "prepaymentIds": "editable", "discountAmount": "editable", "paymentSubjectId": "hidden", "usePrepayWriteOff": "editable", "totalPayableAmount": "editable", "bankAccountSelector": "editable", "supplierConfirmUrls": "editable", "debtIds.workTime": "editable", "debtIds.bizStr": "editable", "debtIds.billTypeName": "editable", "debtIds.totalAmount": "editable", "debtIds.leftAmount": "editable", "debtIds.paymentAmount": "editable", "debtIds.discountAmount": "editable", "prepaymentIds.paidBillStr": "editable", "prepaymentIds.totalAmount": "editable", "prepaymentIds.writeOffAmount": "editable", "prepaymentIds.availableAmount": "editable", "prepaymentIds.useAmount": "editable", "paymentLines.paymentSubjectId": "hidden", "paymentLines.name": "hidden", "paymentLines.amount": "hidden" },
      "1": { "remark": "readonly", "debtIds": "readonly", "erpBillStr": "hidden", "supplierId": "readonly", "paymentType": "readonly", "receiptUrls": "hidden", "actualAmount": "hidden", "paymentLines": "hidden", "prepayAmount": "readonly", "paymentAmount": "readonly", "prepaymentIds": "readonly", "discountAmount": "readonly", "paymentSubjectId": "hidden", "usePrepayWriteOff": "readonly", "totalPayableAmount": "readonly", "bankAccountSelector": "readonly", "supplierConfirmUrls": "readonly", "debtIds.workTime": "readonly", "debtIds.bizStr": "readonly", "debtIds.billTypeName": "readonly", "debtIds.totalAmount": "readonly", "debtIds.leftAmount": "readonly", "debtIds.paymentAmount": "readonly", "debtIds.discountAmount": "readonly", "prepaymentIds.paidBillStr": "readonly", "prepaymentIds.totalAmount": "readonly", "prepaymentIds.writeOffAmount": "readonly", "prepaymentIds.availableAmount": "readonly", "prepaymentIds.useAmount": "readonly", "paymentLines.paymentSubjectId": "hidden", "paymentLines.name": "hidden", "paymentLines.amount": "hidden" },
      "2": { "remark": "readonly", "debtIds": "readonly", "erpBillStr": "hidden", "supplierId": "readonly", "paymentType": "readonly", "receiptUrls": "hidden", "actualAmount": "hidden", "paymentLines": "hidden", "prepayAmount": "readonly", "paymentAmount": "readonly", "prepaymentIds": "readonly", "discountAmount": "readonly", "paymentSubjectId": "hidden", "usePrepayWriteOff": "readonly", "totalPayableAmount": "readonly", "bankAccountSelector": "readonly", "supplierConfirmUrls": "readonly", "debtIds.workTime": "readonly", "debtIds.bizStr": "readonly", "debtIds.billTypeName": "readonly", "debtIds.totalAmount": "readonly", "debtIds.leftAmount": "readonly", "debtIds.paymentAmount": "readonly", "debtIds.discountAmount": "readonly", "prepaymentIds.paidBillStr": "readonly", "prepaymentIds.totalAmount": "readonly", "prepaymentIds.writeOffAmount": "readonly", "prepaymentIds.availableAmount": "readonly", "prepaymentIds.useAmount": "readonly", "paymentLines.paymentSubjectId": "hidden", "paymentLines.name": "hidden", "paymentLines.amount": "hidden" },
      "3": { "remark": "readonly", "debtIds": "readonly", "erpBillStr": "hidden", "supplierId": "readonly", "paymentType": "readonly", "receiptUrls": "editable", "actualAmount": "hidden", "paymentLines": "editable", "prepayAmount": "readonly", "paymentAmount": "readonly", "prepaymentIds": "readonly", "discountAmount": "readonly", "paymentSubjectId": "hidden", "usePrepayWriteOff": "readonly", "totalPayableAmount": "readonly", "bankAccountSelector": "readonly", "supplierConfirmUrls": "readonly", "debtIds.workTime": "readonly", "debtIds.bizStr": "readonly", "debtIds.billTypeName": "readonly", "debtIds.totalAmount": "readonly", "debtIds.leftAmount": "readonly", "debtIds.paymentAmount": "readonly", "debtIds.discountAmount": "readonly", "prepaymentIds.paidBillStr": "readonly", "prepaymentIds.totalAmount": "readonly", "prepaymentIds.writeOffAmount": "readonly", "prepaymentIds.availableAmount": "readonly", "prepaymentIds.useAmount": "readonly", "paymentLines.paymentSubjectId": "editable", "paymentLines.name": "editable", "paymentLines.amount": "editable" },
      "4": { "remark": "readonly", "debtIds": "readonly", "erpBillStr": "readonly", "supplierId": "readonly", "paymentType": "readonly", "receiptUrls": "readonly", "actualAmount": "readonly", "paymentLines": "readonly", "prepayAmount": "readonly", "paymentAmount": "readonly", "prepaymentIds": "readonly", "discountAmount": "readonly", "paymentSubjectId": "readonly", "usePrepayWriteOff": "readonly", "totalPayableAmount": "readonly", "bankAccountSelector": "readonly", "supplierConfirmUrls": "readonly", "debtIds.workTime": "readonly", "debtIds.bizStr": "readonly", "debtIds.billTypeName": "readonly", "debtIds.totalAmount": "readonly", "debtIds.leftAmount": "readonly", "debtIds.paymentAmount": "readonly", "debtIds.discountAmount": "readonly", "prepaymentIds.paidBillStr": "readonly", "prepaymentIds.totalAmount": "readonly", "prepaymentIds.writeOffAmount": "readonly", "prepaymentIds.availableAmount": "readonly", "prepaymentIds.useAmount": "readonly", "paymentLines.paymentSubjectId": "readonly", "paymentLines.name": "readonly", "paymentLines.amount": "readonly" }
    },
  },
};

 ...
 * 递归处理嵌套对象和数组
 */
export type CamelCasedKey<S extends string> = S extends `${infer Head}_${infer Tail}`
 ...
 */
export type SnakeCasedKey<S extends string> = S extends `${infer Head}${infer Tail}`

...
**步骤一** ：调用[发送工作通知](https://open.dingtalk.com/document/development/asynchronous-sending-of-enterprise-session-messages.md)接口获取工作通知任务\`task_id\`。
...
|    名称    |   类型   | 是否必填 |     示例值      |                                                                                                                                                                    描述                                                                                                                                                                     |
|----------|--------|------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| agent_id | Number | 是    | 836390886    | 发送消息时使用的微应用的AgentID。 * 企业内部应用，可在[开发者后台](https://open-dev.dingtalk.com/#/appMgr/inner/h5/836390886/1)的应用详情页面查看。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1380768661/p520676.png) * 第三方企业应用可调用[获取企业授权信息](https://open.dingtalk.com/document/development/obtains-the-basic-information-of-an-enterprise.md)接口获取。 |
| task_id  | Number | 是    | 256271667526 | 发送消息时钉钉返回的任务ID，调用[发送工作通知](https://open.dingtalk.com/document/development/asynchronous-sending-of-enterprise-session-messages.md)接口获取task_id参数值。 **说明** 仅支持查询24小时内的任务。                                                                                                                                                                     |

## 返回参数

|           名称           |           类型           |            示例值             |                                                                             描述                                                                              |
|------------------------|------------------------|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| send_result            | AsyncSendResult        | <br />                     | 返回结果。                                                                                                                                                       |
...
| forbidden_list         | SendForbiddenModel\[\] | <br />                     | 推送被禁止的具体原因。                                                                                                                                                 |
